...
| C1 | One ladder | TODO | | | `20270132_wizard_policy_v2_keys` (from branch) | tiers | | — | closes 9.2, 9.5, 9.6 |
| C2 | `requires_site_check` decided once | TODO | | | none | — | | — | closes 9.1; proving rows correction SQL for Tom |
| C3 | Draft versioning, one server truth | TODO | | | `wizard_drafts` + version, last_screen | — | | — | A1b status |
