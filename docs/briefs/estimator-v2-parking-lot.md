...
| C3 | `e2e/customer-journey/draft-versioning.spec.ts` is unrun pending `20270136` on the C1 test project. It is the accept criterion for C3 and should be the first thing run after the migration lands. |
