...
## Steps
1. Look at the top of any portal screen, between the logo and your name: a cyan circle with a **sun** (☀) in it. The picture shows what you will GET if you press it — a sun while you are in the dark look, a **moon** (☾) while you are in the light one.
