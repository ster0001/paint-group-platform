...
- **Update your work order — reminders** texts every painter on a job under way to tick what is done and add the day's photos, with a link to the job. The moments depend on the booking's length in the painter's working days: a 1–2 day job gets day 1 at 7:30 am and day 2 at 3:30 pm; a 3–6 day job gets day 1 at 7:30 am, half way at 3:30 pm and the last day at 3:30 pm; a job of 7 days or more gets day 1, 30%, 60% and the last day. Each moment goes once per job and stops when the job reaches its quality check, walkthrough or close. It goes out at 7:30 am regardless of the sending hours. The same half-way point puts a **Check-in** item on Today for the office (see the work-orders guide).
