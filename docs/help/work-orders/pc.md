...
16b. Today lists the customer check-ins for you, worked out from each booking's length in the painter's working days. A **3–6 day job** puts a **Check-in** item on the day half way through ("mid-job check-in, 50% through, day 3 of 5"), due by 5 pm; a **job of 7 days or more** gets two, at 35% and 70%. These rank high — a customer with a question mid-job is who the call is for. A **1–2 day job** gets a **Follow-up** item instead, due the next business morning after its last booked day: ring and check they are happy. **Ring them** opens the job; dismiss the item from Today once you have called. The painter is texted to update their work order on the same rhythm.
