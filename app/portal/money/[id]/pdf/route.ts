...
/**
 * The contractor downloads THEIR OWN invoice PDF. Ownership is proven by the
 * RLS read (their session only sees their rows); the file heals if the
 * after() render at submit time didn't land; the bucket stays private —
 * a short-lived signed URL does the serving.
 */
