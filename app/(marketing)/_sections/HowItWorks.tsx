    ...
    <section className="sec light warm" id="how">
      <div className="wrap">
        ...
        <div className="grid4">
          ...
          <div className="card"><span className="n">02</span><h3>We confirm it with you</h3><p>The more you tell us, the tighter the range. Then a real person checks it — over the phone for apartments, units and smaller jobs, on site for larger ones — and signs it off with you.</p></div>
          ...
          <div className="card"><span className="n">04</span><h3>Sign off, then pay</h3><p>Photo updates every day in your portal. A walkthrough with you at the end. You sign off, then the final invoice is due.</p></div>
        </div>
