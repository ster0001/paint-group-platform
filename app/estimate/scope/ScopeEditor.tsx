...
export default function ScopeEditor({ estimateId, initial, initialRooms, initialExterior = null, initialSides = null, initialLadder, initialInteriorLoop = null, roomTypes, liveRange, docs = { plan: null, photos: [] }, logoUrl = null, companyPhone = null, phoneHours = null, customerPhone = null, chatMode = false }: {
  ...
  const [ladder, setLadder] = useState<Ladder>(initialLadder ?? { tier: "bronze", selfServe: false, reason: null, visitSlots: [], nextUnlock: null });
            ...
            <div className="sc-score">
              ...
              <div className="sc-lbl">
                ...
                {/* PR 1 of the tiers plan: the next unlock never names a target this
                    road can't reach — a no-plan job is shown Silver as its goal and
                    Gold as "upload your floorplan". */}
