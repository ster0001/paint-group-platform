...
import { advanceStage, deliverEvidencePack } from "../../actions";
 ...
 */
export default function StageAdvance({ workOrderId, stage }: { workOrderId: string; stage: WoStage }) {
  ...
  return (
    <div className="card" data-testid="stage-advance">
      ...
      <p className="note">
        {stage === "pre_start" ? "The pre-start list has to be true before a job can start."
