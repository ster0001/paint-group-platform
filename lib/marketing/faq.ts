...
export const FAQS: ReadonlyArray<{ q: string; a: string }> = [
  ...
  { q: "Who does the painting?",
    a: "Our own trusted network of painters, who are quality-checked, fully insured and used to working in people's homes and businesses. You'll see who's coming in your portal before the start date is locked in." },
  ...
  { q: "Do I need to be home?",
    a: "Not while the painting happens. We'll agree access with you and send regular photo updates. The final walkthrough is done with you there, so we'll book it for a time that works." },
