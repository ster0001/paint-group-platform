...
export const SAMPLE_VARS: Record<string, string> = {
  ...
  expiry_time: "6:00 pm", day_label: "day 3 of 5", access_notes: "Side gate, key in lockbox 4471", colour_status: "Dulux Natural White, confirmed",
  ...
  hours_since: "74",
  customer: "Sarah Chen", message: "Is the ceiling included in the price?", hours_tag: "",
