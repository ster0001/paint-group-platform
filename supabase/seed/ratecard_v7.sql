...
insert into public.products (name, type, coverage, price_per_litre, wastage_pct, effective_from) values
  ...
  ('Haymes Trim Plus', 'Interior', 16, 2000, 10, current_date),
...
begin
  if exists (select 1 from public.rate_cards where version = 7) then
    ...
    insert into public.rate_items (rate_card_id, code, category, sub_category, unit, rate_1_coat, rate_2_coat, rate_3_coat, default_coats, charge_out_cents, default_product, metres_per_litre, litres_per_item_per_coat) values
      ...
      (v_card, 'Skirting Boards', 'Interior', 'Interior Trim', 'Lineal Metres', 20.47, 11.69, 8.19, 2, 8500, 'Haymes Trim Plus', 103, null),
      (v_card, 'Skirting Boards MDF', 'Interior', 'Interior Trim', 'Lineal Metres', 20.47, 11.69, 8.19, 3, 8500, 'Haymes Trim Plus', 103, null),
      (v_card, 'Picture Rails', 'Interior', 'Interior Trim', 'Lineal Metres', 20.47, 11.69, 8.19, 2, 8500, 'Haymes Trim Plus', 200, null),
      (v_card, 'Balustrades', 'Interior', 'Interior Trim', 'Lineal Metres', 6.55, 3.74, 2.62, 2, 8500, 'Haymes Trim Plus', 32, null),
      (v_card, 'Flat Door and Frame (1 Side)', 'Interior', 'Interior Doors', 'Hours Per Item', 0.61, 1.07, 1.53, 2, 8500, 'Haymes Trim Plus', null, 0.16),
      (v_card, 'Flat Door (1 Side)', 'Interior', 'Interior Doors', 'Hours Per Item', 0.31, 0.53, 0.76, 2, 8500, 'Haymes Trim Plus', null, 0.1),
      (v_card, '4-6 Panel Door and Frame (1 Side)', 'Interior', 'Interior Doors', 'Hours Per Item', 0.92, 1.6, 2.29, 2, 8500, 'Haymes Trim Plus', null, 0.19),
      (v_card, '4-6 Panel Door (1 Side)', 'Interior', 'Interior Doors', 'Hours Per Item', 0.46, 0.8, 1.14, 2, 8500, 'Haymes Trim Plus', null, 0.13),
      (v_card, 'Architrave (1 Side)', 'Interior', 'Interior Doors', 'Hours Per Item', 0.31, 0.53, 0.76, 2, 8500, 'Haymes Trim Plus', null, 0.06),
      (v_card, 'Fixed / Picture / Window Reveal', 'Interior', 'Interior Windows', 'Hours Per Item', 0.76, 1.34, 1.91, 2, 8500, 'Haymes Trim Plus', null, 0.2),
      (v_card, 'Awning / Casement Window', 'Interior', 'Interior Windows', 'Hours Per Item', 0.92, 1.6, 2.67, 2, 8500, 'Haymes Trim Plus', null, 0.2),
      (v_card, 'Double Hung Sash', 'Interior', 'Interior Windows', 'Hours Per Item', 1.22, 2.14, 3.06, 2, 8500, 'Haymes Trim Plus', null, 0.25),
      (v_card, 'Colonial / Bay Window', 'Interior', 'Interior Windows', 'Hours Per Item', 1.83, 3.21, 4.59, 2, 8500, 'Haymes Trim Plus', null, 0.25),
